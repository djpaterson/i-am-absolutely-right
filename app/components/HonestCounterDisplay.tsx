...
interface HonestCounterDisplayProps {
  count: number
  isLoading: boolean
}

export default function HonestCounterDisplay({ count, isLoading }: HonestCounterDisplayProps) {
    ...
    <div className="flex flex-col items-center justify-center py-16">
      ...
      <div className="mt-6 text-center">
        <p className="text-lg md:text-xl text-gray-600 font-medium">
          Times Claude got honest
        </p>
        {isAnimating && (
          <p className="text-sm text-emerald-600 mt-2 animate-bounce">
            🫡 Honesty detected! 🫡
          </p>
        )}
      </div>
